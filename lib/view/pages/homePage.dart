  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 1, // Indeks ke-1 adalah "Our Menu"
        selectedItemColor: Colors.blue,
        onTap: (int index) {
          if (index == 0) {
            // Jika ikon "Home" ditekan, kembali ke halaman sebelumnya
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(
            ...
            // Jika ikon "Our Menu" ditekan, tidak lakukan apa-apa (sudah di halaman "Our Menu")
          } else if (index == 2) {
            // Jika ikon "My Account" ditekan, navigasi ke halaman "My Account"
            // Tambahkan kode navigasi sesuai kebutuhan Anda
          }
        },
      ),
    );
